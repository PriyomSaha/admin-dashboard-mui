...
import { Box, Grid, Paper, Typography,Tooltip, IconButton, Stack } from "@mui/material";
  ...
  return (
    <Grid item xs={12} sm={12} md={12} lg={4}>
      <Paper elevation={3} className="graphContainer">
        ...
        <Typography sx={{ mt: 4 }}>
            Total :{" "}
            {totalCounts.delivery}
          </Typography>
        </Box>

        <Tooltip title="Add" arrow>
          <IconButton sx={{ mt: 1.25, ml: 20, position: "absolute" }}>
